function [ affine_xform, times_good, pos_h, colors_xy ] = get_affine_xform( cds, kinect_times, all_medians, x_lim_handle, y_lim_handle, plot_flag )
...
affine_xform = find_affine_xform(pos_k,pos_h);
